...
{
    public class CollectorStaffDto
    {
        ...
        [JsonPropertyName("collector_hub_id")]
    ...
    public class AddCollectorStaffData
    {
        [Required]
        [JsonPropertyName("user_id")]
        public Guid UserId { get; set; }
    ...
    public class AddCollectorStaffRequest
    {
        [Required]
        public AddCollectorStaffData Data { get; set; } = null!;
    }
}
